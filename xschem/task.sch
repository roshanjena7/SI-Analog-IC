...
N -10 110 90 110 {lab=GND}
N -10 110 -10 130 {lab=GND}
N 90 70 90 110 {lab=GND}
N -10 10 20 10 {lab=GND}
N -120 110 -10 110 {lab=GND}
N -10 40 -10 60 {lab=#net1}
N 20 10 90 10 {lab=GND}
N 90 10 90 70 {lab=GND}
N -120 -50 -120 10 {lab=vgds}
N -120 -50 -10 -50 {lab=vgds}
N -10 -50 -10 -20 {lab=vgds}
N -70 10 -50 10 {lab=vgds}
N -70 -50 -70 10 {lab=vgds}
...
C {vsource.sym} -120 40 0 0 {name=Vds value=1 savecurrent=false}
C {gnd.sym} -10 130 0 0 {name=l1 lab=GND}
C {vsource.sym} -10 80 0 0 {name=Vsb value=0 savecurrent=false}
C {lab_wire.sym} -110 -50 0 0 {name=p2 sig_type=std_logic lab=vgds}
